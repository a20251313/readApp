...
//	label.layer.masksToBounds = YES;
	...
	v.frame = CGRectMake(0, 400, textSize.width + 10, textSize.height + 10);
	...
	NSTimer *timer1 = [NSTimer timerWithTimeInterval:((float)theSettings.duration)/400 
...
- (void) hideToast:(NSTimer*)theTimer{
	...
	NSTimer *timer2 = [NSTimer timerWithTimeInterval:0.1
